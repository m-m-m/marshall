 ...
 * <b>ATTENTION:</b><br>
 * Generic methods such as {@link net.sf.mmm.marshall.StructuredWriter#writeValue(Object)} and especially
 * {@link net.sf.mmm.marshall.StructuredReader#readValue(Class)} only exist for convenience and simple usage. They
